...
const Footer = () => {
  ...
  return (
    <>
      <div className='w-[100%] h-[55px] bg-black flex mx-auto'>
        <ul className="w-full h-full flex  justify-center  items-center">
          <li className="text-white flex justify-center items-center  sm::text-[10px] md:text-[15px]  font-semibold">Developer: Raja Umer Saleem </li>
